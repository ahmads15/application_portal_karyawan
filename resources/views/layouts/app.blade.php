...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href=" {{url('dashboard')}}">
                        <!-- Logo text -->
                        <span>
                            <img src="{{asset("images/emportal.png")}}" class="" alt="homepage" /></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
        ...
        <aside class="left-sidebar">
            ...
            <nav class="sidebar-nav" style="position: relative;bottom: 23px;">
                <ul id="sidebarnav">
                    ...
                    <li>
                        <a href="#"> <i class="mdi mdi-credit-card"></i> Employee Payroll</a>
                    </li>
                    @endcan
                    @can('Employee Report')
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false" class="collapse">
                            ...
                            @can('Manage Division')
                            <li>
                                <a href="{{url('master-division')}}">Division Master</a>
                            </li>
                            @endcan
                            @can('Manage Position')
                            <li>
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li>
                                <a href="{{url('masterdata-payrollmaster-salarylevelmaster')}}">Salary Leave
                                    Master</a>
                            </li>
                            <li>
                                <a href="{{ url('masterdata-payrollmaster-incentivemaster') }}"><i
                                        class="fa fa-circle-o"></i>Incentive Master</a>
                            </li>
                            <li>
                                <a href="{{ url('masterdata-payrollmaster-leavetypemaster') }}"><i
                                        class="fa fa-circle-o"></i>Leave Type Master</a>
                            </li>
                            <li>
                                <a href="{{ url('masterdata-payrollmaster-BPJStypemaster') }}"><i
                                        class="fa fa-circle-o"></i>BPJS Type Master</a>
                            </li>
                            <li>
                                <a href="{{ url('masterdata-payrollmaster-PPHtypemaster') }}"><i
                                        class="fa fa-circle-o"></i>PPH Type Master</a>
                            </li>
                            <li>
                                <a href="{{ url('masterdata-payrollmaster-PTKPtypemaster') }}"><i
                                        class="fa fa-circle-o"></i>PTKP Type Master</a>
                            </li>
                        </ul>
                    </li>
                    @endcan
    ...
    <script src="{{asset('chartist-js/dist/chartist.min.js')}}"></script>
    <script src="{{asset("plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js")}}"></script>
    <script src="{{asset("plugins/chartist-js/dist/chartist-init.js")}}"></script>
    <!-- Editable -->
