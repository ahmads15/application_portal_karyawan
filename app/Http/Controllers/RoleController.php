...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('roles.index', compact('roles', 'select_roles'));
    }
    ...
    {
        $role = Role::find($id); /*Mengambil data user sesuai id user*/
        $role->delete(); /*Menghapus user yang dipilih sesuai id user*/
